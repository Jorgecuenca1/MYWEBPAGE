"""
Django settings for portfolio_jorge project.
...
SECRET_KEY = 'django-insecure-hdmwoyh1a)tv8*79k%g6=p=*^dg(!@sw@p*(@x)uwr$wwhthq('
...
ROOT_URLCONF = 'portfolio_jorge.urls'
...
WSGI_APPLICATION = 'portfolio_jorge.wsgi.application'
